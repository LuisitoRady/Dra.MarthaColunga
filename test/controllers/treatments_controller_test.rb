...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { dosis: @treatment.dosis, instructions: @treatment.instructions, user_id: @treatment.user_id } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { dosis: @treatment.dosis, instructions: @treatment.instructions, user_id: @treatment.user_id } }
